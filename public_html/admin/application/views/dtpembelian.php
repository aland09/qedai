                            ...
                            <div class="table-responsive mb-4 mt-4">
                                <table id="zero-config" class="table table-hover" style="width:100%">
                                    ...
                                    <tbody>
                                      ...
                                      ?>
                                      <tr>
                                          <td><?php echo $pm['nameitm']; ?></td>
                                          <td><?php echo $pm['DBLQTY_ORDER_Q']; ?></td>
                                          <td><?php echo $pm['DBLQTY_TOTAL']; ?></td>
                                          <td><?php echo $pm['DBLPRICE_Q']; ?></td>
                                          <td><?php echo $pm['DBLAMOUNT']; ?></td>
                                          <td></td>
                                          <!--
                                          <td></td>
                                          <td></td>
