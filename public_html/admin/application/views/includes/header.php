...
<head>
    ...
    .nav-item.pcoded-submenu.xcx a {
      background: #f0544d !important;
      color: #fff !important;
...
<body class="">
		...
		<div class="navbar-wrapper  ">
			<div class="navbar-content scroll-div " >
				...
				<div class="">
					<div class="main-menu-header">
						...
						<div class="user-details">
							<div id="more-details"><?php echo $name; ?><i class="fa fa-caret-down"></i></div>
						</div>
					</div>
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item pcoded-submenu xcx">
						<a href="#!" ><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Dashboard</span></a>
	...
	<header class="navbar pcoded-header navbar-expand-lg navbar-light header-blue">
            ...
            <h3 style="color:#fff;">  QEDAI.ID </h3>
